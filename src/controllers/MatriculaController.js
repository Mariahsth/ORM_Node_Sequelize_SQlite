      ...
      const cursosLotados= await matriculaServices.pegaEContaRegistros(
        {
          ...
          attributes: ['curso_id'],
          group: ['curso_id'],      //Agrupando a contagem de matriculas com o id dos cursos
          having: Sequelize.literal(`count(curso_id) >= ${lotacaoCurso}`)   //limitando para aparecer apenas os cursos lotados, utilizando linguagem SQL dentro do ORM sequelize
